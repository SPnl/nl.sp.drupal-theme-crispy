 ...
 */
function crispy_preprocess_maintenance_page(&$vars) {
  // Markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // crispy_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  crispy_preprocess_html($vars);
}

/**
 * Override or insert variables into the html template.
 */
function crispy_preprocess_html(&$vars) {
 ...
 */
function crispy_preprocess_page(&$vars) {
 ...
 */
function crispy_node_add_list($variables) {
 ...
 */
function crispy_admin_block_content($variables) {
  $content = $variables['content'];
  $output = '';
  if (!empty($content)) {
 ...
 */
function crispy_tablesort_indicator($variables) {
